...
require dirname(__FILE__)."/../../Proyecto 1ª Evaluación/vendor/autoload.php";
...
function enviar_correo_multiples($lista_correos,  $cuerpo,  $asunto = ""){
		...
		$mail->Port       = 587;                   
		$mail->Username   = "69629862a446c6";  //usuario de gmail
		$mail->Password   = "d52e605a66a13d"; //contraseña de gmail          
